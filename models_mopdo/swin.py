...
class MoPDOLinear(nn.Linear):
    def __init__(self, size_in, size_out, bias=True, rlrr_enable=False):
        super(MoPDOLinear, self).__init__(size_in, size_out, bias=True)
...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, bias=True, drop=0.,
        ...
        self.fc1 = MoPDOLinear(in_features, hidden_features, bias=bias[0], rlrr_enable=rlrr_enable)
        self.act = act_layer()
        self.drop1 = nn.Dropout(drop_probs[0])
        self.fc2 = MoPDOLinear(hidden_features, out_features, bias=bias[1], rlrr_enable=rlrr_enable)
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, attn_drop=0., proj_drop=0., rlrr_enable=True):
        ...
        self.qkv = MoPDOLinear(dim, dim * 3, bias=qkv_bias, rlrr_enable=rlrr_enable)
        self.attn_drop = nn.Dropout(attn_drop)
        self.proj = MoPDOLinear(dim, dim, rlrr_enable=rlrr_enable)
...
class PatchMerging(nn.Module):
    ...
    def __init__(self, input_resolution, dim, norm_layer=nn.LayerNorm, rlrr_enable=True):
        ...
        self.input_resolution = input_resolution
        self.dim = dim
        self.reduction = MoPDOLinear(4 * dim, 2 * dim, bias=False, rlrr_enable=rlrr_enable)
