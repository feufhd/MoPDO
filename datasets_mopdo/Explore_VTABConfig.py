...
def get_caltech101_config():
    ...
    config.path = '/data/Datasets/vtab-1k/caltech101'
    ...
    config.lr = 0.0015
    config.drop_path = 0.05
    config.min_lr = 1e-8
    config.warmup_lr = 1e-7
    config.weight_decay = 5e-5

    config.entropy_scale = 0.001
    return config


def get_cifar_config():
    config = ml_collections.ConfigDict()
    config.path = './data/vtab-1k/cifar'
...
def get_dtd_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/dtd'
    ...
    config.min_lr = 1e-8
    config.warmup_lr = 1e-7
    config.weight_decay = 7.5e-5

    config.entropy_scale = 0.004
    return config


def get_oxford_flowers102_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/oxford_flowers102'
    config.num_classes = 102
    config.CropSize = 224
    config.num_workers = 6
    config.pin_memory = True
    ...
    config.simple_aug = False
    config.lr = 0.002
    config.drop_path = 0.25
    config.min_lr = 1e-8
    config.warmup_lr = 1e-7
    config.weight_decay = 0.0005

    config.entropy_scale = 0.05
    return config


def get_oxford_iiit_pet_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/oxford_iiit_pet'
    ...
    config.drop_path = 0
    config.min_lr = 1e-8
    config.warmup_lr = 1e-7 # 1e-7
    config.weight_decay = 0.0001

    config.entropy_scale = 5e-5
    return config

def get_svhn_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/svhn'
    ...
    config.simple_aug = False
    config.lr = 0.004
    config.drop_path = 0.35
    config.min_lr = 1e-8
    config.warmup_lr = 1e-7
    config.weight_decay = 5e-5

    config.entropy_scale = 0
    return config


def get_sun397_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/sun397'
...
def get_patch_camelyon_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/patch_camelyon'
    ...
    config.entropy_scale = 0.0001
    return config


def get_eurosat_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/eurosat'
    config.num_classes = 10
    config.CropSize = 224
    config.num_workers = 6
    config.pin_memory = True
    ...
    config.min_lr = 1e-8
    config.warmup_lr = 1e-7
    config.weight_decay = 1.25e-5

    config.entropy_scale = 5e-6
    return config


def get_resisc45_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/resisc45'
...
def get_diabetic_retinopathy_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/diabetic_retinopathy'
...
def get_clevr_count_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/clevr_count'
...
def get_clevr_dist_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/clevr_dist'
...
def get_dmlab_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/dmlab'
    config.num_classes = 6
    config.CropSize = 224
    config.num_workers = 6
    config.pin_memory = True
    ...
    config.min_lr = 1e-8
    config.warmup_lr = 1e-7
    config.weight_decay = 2.5e-5

    config.entropy_scale = 4e-5
    return config


def get_kitti_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/kitti'
...
def get_dsprites_loc_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/dsprites_loc'
...
def get_dsprites_ori_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/dsprites_ori'
    config.num_classes = 16
    config.CropSize = 224
    config.num_workers = 6
    config.pin_memory = True
...
def get_smallnorb_azi_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/smallnorb_azi'
...
def get_smallnorb_ele_config():
    config = ml_collections.ConfigDict()
    config.path = '/data/Dataset/vtab-1k/smallnorb_ele'
