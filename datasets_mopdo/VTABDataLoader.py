...
class ImageFilelist(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return img, target #s, os.path.join(self.root, impath)

    def __len__(self):
        return len(self.imlist)


def get_data(data_path, simple_aug=False, name='', evaluate=True, batch_size=32, few_shot=False, shot=1, seed=1, mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5), num_workers=6):
    if few_shot:
